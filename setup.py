...
# Fields marked as "Optional" may be commented out.
    ...
    setup(
    name='volumetric_analysis',  # Required
    version='1.0',  # Required
    description='Volumetric analysis of C. elegans connectome data',  # Optional
    long_description=long_description,  # Optional
    long_description_content_type='text/markdown',  # Optional (see note above)
    url='https://github.com/cabrittin/volumetric_analysis',  # Optional
    ...
    keywords='C. elegans connectome',  # Optional
    ...
    project_urls={  # Optional
        'Source': 'github.com/cabrittin/volumetric_analysis',
    },
)
